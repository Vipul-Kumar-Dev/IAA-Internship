...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, username, email, password=None, firstname=None):
        user = self.create_user(username, email, password, firstname=firstname)
        user.is_admin = True
        user.save(using=self._db)
        return user
...
class User(AbstractBaseUser):
    ...
    def has_perm(self, perm, obj=None):
        return self.is_admin  # Grant all permissions to admins
